<?php header("refresh: 1800; url=http://srmhitter9062.byethost7.com/increment.php"); ?>
<?php
...
echo "<br />";
echo $tit;
$con1 = mysql_connect("sql304.byethost7.com","b7_15693682","srmalexander20693");
if (!$con1)
  {
  die('Could not connect: ' . mysql_error());
  }
mysql_select_db("b7_15693682_srm", $con1);
