<?php header("refresh: 1800; url=http://srmhitter9062.byethost7.com/private_college1.php"); ?>
<?php
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_content">
    	<?php include 'private_collegeq.php';?>
    ...
    <div id="templatemo_sidebar">
        ...
        <div class="sb_box">
            ...
            <ul class="sb_list">
                ...
                <li><a href="private_college1.php"><font color='red'>Private Colleges</font></a></li>
