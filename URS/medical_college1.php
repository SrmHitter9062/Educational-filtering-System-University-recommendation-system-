<?php header("refresh: 1800; url=http://srmhitter9062.byethost7.com/medical_college1.php"); ?>
<?php
...
<div id="toppanel">
	<div id="panel">
		<div class="content clearfix">
			...
			<div class="left">
				<!-- Login Form -->
				<form method="POST" action="/login/loginproc.php">
					<h1>Member Login</h1>
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_content">
    	<?php include 'medical_collegeq.php';?>
    ...
    <div id="templatemo_sidebar">
		...
		<li><a href="iim1.php">IIMS</a></li>
		<li><a href="medical_college1.php"><font color='red'>Medical colleges</font></a></li>
